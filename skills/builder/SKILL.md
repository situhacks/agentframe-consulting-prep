...
- **Add cases:** drop a casebook PDF in, convert it to markdown under `library/cases/`, and add a row per case
  to `case-tracker.md` (the index the agent reads to pick an unrun case).
